...
80101ec8:	68 62 77 10 80       	push   $0x80107762
...
80103301:	e8 da 0f 00 00       	call   801042e0 <initlock>
  (*f0)->type = FD_PIPE;
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 37 11 00 00       	jmp    801044e0 <release>
...
801033d4:	e8 07 11 00 00       	call   801044e0 <release>
    kfree((char*)p);
...
801034eb:	e8 f0 0f 00 00       	call   801044e0 <release>
  return n;
...
8010357e:	e8 5d 0f 00 00       	call   801044e0 <release>
      return -1;
...
801035df:	e8 fc 0e 00 00       	call   801044e0 <release>
  return i;
...
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 89 0e 00 00       	call   801044e0 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 31 57 10 80 	movl   $0x80105731,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 a5 0e 00 00       	call   80104530 <memset>
...
801036aa:	e8 31 0e 00 00       	call   801044e0 <release>
}
...
801036db:	e8 00 0e 00 00       	call   801044e0 <release>
...
80103730:	e8 ab 0b 00 00       	call   801042e0 <initlock>
}
...
801037ad:	68 48 76 10 80       	push   $0x80107648
...
80103ae4:	75 47                	jne    80103b2d <scheduler+0x8d>
      switchuvm(p);
...
80103af5:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103af8:	83 c4 0c             	add    $0xc,%esp
80103afb:	ff 73 10             	pushl  0x10(%ebx)
      p->state = RUNNING;
80103afe:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      cprintf("Process chosen: %s\tPID: %d\n", p->name, p->pid);
80103b05:	50                   	push   %eax
80103b06:	68 30 75 10 80       	push   $0x80107530
80103b0b:	e8 50 cb ff ff       	call   80100660 <cprintf>
      swtch(&(c->scheduler), p->context);
80103b10:	58                   	pop    %eax
80103b11:	5a                   	pop    %edx
80103b12:	ff 73 1c             	pushl  0x1c(%ebx)
80103b15:	57                   	push   %edi
80103b16:	e8 50 0c 00 00       	call   8010476b <swtch>
      switchkvm();
80103b1b:	e8 90 2d 00 00       	call   801068b0 <switchkvm>
      c->proc = 0;
80103b20:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b27:	00 00 00 
80103b2a:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b2d:	83 c3 7c             	add    $0x7c,%ebx
80103b30:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80103b36:	72 a8                	jb     80103ae0 <scheduler+0x40>
    release(&ptable.lock);
80103b38:	83 ec 0c             	sub    $0xc,%esp
80103b3b:	68 20 2d 11 80       	push   $0x80112d20
80103b40:	e8 9b 09 00 00       	call   801044e0 <release>
    sti();
80103b45:	83 c4 10             	add    $0x10,%esp
80103b48:	e9 73 ff ff ff       	jmp    80103ac0 <scheduler+0x20>
...
80103d1d:	68 99 75 10 80       	push   $0x80107599
80103d22:	e8 69 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d27:	83 ec 0c             	sub    $0xc,%esp
80103d2a:	68 8c 75 10 80       	push   $0x8010758c
...
80103e39:	68 ab 75 10 80       	push   $0x801075ab
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 a5 75 10 80       	push   $0x801075a5
...
80103ee2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ee9:	e8 92 2d 00 00       	call   80106c80 <freevm>
        release(&ptable.lock);
...
8010403b:	68 7b 79 10 80       	push   $0x8010797b
...
8010405e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104061:	ba bc 75 10 80       	mov    $0x801075bc,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104066:	77 11                	ja     80104079 <procdump+0x59>
80104068:	8b 14 85 70 76 10 80 	mov    -0x7fef8990(,%eax,4),%edx
      state = "???";
8010406f:	b8 bc 75 10 80       	mov    $0x801075bc,%eax
...
80104081:	68 c0 75 10 80       	push   $0x801075c0
...
801040a8:	e8 53 02 00 00       	call   80104300 <getcallerpcs>
...
801040e8:	68 20 2d 11 80       	push   $0x80112d20
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040ed:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
801040f2:	e8 29 03 00 00       	call   80104420 <acquire>
    cprintf("name \t ProcID \t state\n");
801040f7:	c7 04 24 c9 75 10 80 	movl   $0x801075c9,(%esp)
801040fe:	e8 5d c5 ff ff       	call   80100660 <cprintf>
80104103:	83 c4 10             	add    $0x10,%esp
80104106:	eb 1d                	jmp    80104125 <procStat+0x45>
80104108:	90                   	nop
...
80104113:	74 5b                	je     80104170 <procStat+0x90>
            cprintf("%s \t %d \t RUNNING\n", p->name, p->pid);
        }
	else if (p->state == SLEEPING) {
80104115:	83 f8 02             	cmp    $0x2,%eax
80104118:	74 76                	je     80104190 <procStat+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010411a:	83 c3 7c             	add    $0x7c,%ebx
8010411d:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80104123:	73 2a                	jae    8010414f <procStat+0x6f>
        if (p->state == RUNNABLE) {
80104125:	8b 43 0c             	mov    0xc(%ebx),%eax
80104128:	83 f8 03             	cmp    $0x3,%eax
8010412b:	75 e3                	jne    80104110 <procStat+0x30>
            cprintf("%s \t %d \t RUNNABLE\n", p->name, p->pid);
8010412d:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104130:	83 ec 04             	sub    $0x4,%esp
80104133:	ff 73 10             	pushl  0x10(%ebx)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104136:	83 c3 7c             	add    $0x7c,%ebx
            cprintf("%s \t %d \t RUNNABLE\n", p->name, p->pid);
80104139:	50                   	push   %eax
8010413a:	68 e0 75 10 80       	push   $0x801075e0
8010413f:	e8 1c c5 ff ff       	call   80100660 <cprintf>
80104144:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104147:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
8010414d:	72 d6                	jb     80104125 <procStat+0x45>
...
80104152:	68 20 2d 11 80       	push   $0x80112d20
80104157:	e8 84 03 00 00       	call   801044e0 <release>

    return 22; // system call number (might be different in your case)

}
8010415c:	b8 16 00 00 00       	mov    $0x16,%eax
...
80104169:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            cprintf("%s \t %d \t RUNNING\n", p->name, p->pid);
80104170:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104173:	83 ec 04             	sub    $0x4,%esp
80104176:	ff 73 10             	pushl  0x10(%ebx)
80104179:	50                   	push   %eax
8010417a:	68 f4 75 10 80       	push   $0x801075f4
8010417f:	e8 dc c4 ff ff       	call   80100660 <cprintf>
80104184:	83 c4 10             	add    $0x10,%esp
80104187:	eb 91                	jmp    8010411a <procStat+0x3a>
...
8010419a:	68 07 76 10 80       	push   $0x80107607
8010419f:	e8 bc c4 ff ff       	call   80100660 <cprintf>
801041a4:	83 c4 10             	add    $0x10,%esp
801041a7:	e9 6e ff ff ff       	jmp    8010411a <procStat+0x3a>
...
801041ba:	68 88 76 10 80       	push   $0x80107688
...
801043d5:	68 93 76 10 80       	push   $0x80107693
801043da:	e8 b1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043df:	83 ec 0c             	sub    $0xc,%esp
801043e2:	68 aa 76 10 80       	push   $0x801076aa
...
801044c7:	68 b1 76 10 80       	push   $0x801076b1
...
8010451c:	68 b9 76 10 80       	push   $0x801076b9
...
80104937:	83 fa 15             	cmp    $0x15,%edx
8010493a:	77 1c                	ja     80104958 <syscall+0x38>
8010493c:	8b 14 85 e0 76 10 80 	mov    -0x7fef8920(,%eax,4),%edx
...
80104960:	68 c1 76 10 80       	push   $0x801076c1
...
80104ab4:	68 58 77 10 80       	push   $0x80107758
...
80104acc:	68 57 77 10 80       	push   $0x80107757
...
80104ae5:	68 4b 77 10 80       	push   $0x8010774b
...
80104afa:	68 5a 77 10 80       	push   $0x8010775a
80104aff:	e8 8c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b04:	83 ec 0c             	sub    $0xc,%esp
80104b07:	68 3c 77 10 80       	push   $0x8010773c
...
80104ef9:	58                   	pop    %eax
80104efa:	5a                   	pop    %edx
80104efb:	68 58 77 10 80       	push   $0x80107758
...
80104f14:	68 57 77 10 80       	push   $0x80107757
...
801054ac:	e8 8f dd ff ff       	call   80103240 <pipealloc>
...
80105713:	5d                   	pop    %ebp
	return procStat();
80105714:	e9 c7 e9 ff ff       	jmp    801040e0 <procStat>
...
80105728:	54                   	push   %esp
  call trap
80105729:	e8 c2 00 00 00       	call   801057f0 <trap>
  addl $4, %esp
...
8010578e:	00 00 ef 
  initlock(&tickslock, "time");
80105791:	68 9d 77 10 80       	push   $0x8010779d
...
801057a4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801057aa:	e8 31 eb ff ff       	call   801042e0 <initlock>
}
...
80105810:	ff 24 85 44 78 10 80 	jmp    *-0x7fef87bc(,%eax,4)
...
80105875:	68 00 78 10 80       	push   $0x80107800
...
8010590d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105910:	e8 0b f0 ff ff       	call   80104920 <syscall>
    if(myproc()->killed)
...
801059b7:	68 a8 77 10 80       	push   $0x801077a8
...
801059fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105a00:	e8 0b e2 ff ff       	call   80103c10 <exit>
...
80105a55:	68 cc 77 10 80       	push   $0x801077cc
80105a5a:	e8 01 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a5f:	83 c4 14             	add    $0x14,%esp
80105a62:	68 a2 77 10 80       	push   $0x801077a2
...
80105b5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b5f:	bb c4 78 10 80       	mov    $0x801078c4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105bf7:	6a 00                	push   $0x0
  jmp alltraps
80105bf9:	e9 1b fb ff ff       	jmp    80105719 <alltraps>
...
80105c00:	6a 01                	push   $0x1
  jmp alltraps
80105c02:	e9 12 fb ff ff       	jmp    80105719 <alltraps>
...
80105c09:	6a 02                	push   $0x2
  jmp alltraps
80105c0b:	e9 09 fb ff ff       	jmp    80105719 <alltraps>
...
80105c12:	6a 03                	push   $0x3
  jmp alltraps
80105c14:	e9 00 fb ff ff       	jmp    80105719 <alltraps>
...
80105c1b:	6a 04                	push   $0x4
  jmp alltraps
80105c1d:	e9 f7 fa ff ff       	jmp    80105719 <alltraps>
...
80105c24:	6a 05                	push   $0x5
  jmp alltraps
80105c26:	e9 ee fa ff ff       	jmp    80105719 <alltraps>
...
80105c36:	6a 07                	push   $0x7
  jmp alltraps
80105c38:	e9 dc fa ff ff       	jmp    80105719 <alltraps>
...
80105c3d:	6a 08                	push   $0x8
  jmp alltraps
80105c3f:	e9 d5 fa ff ff       	jmp    80105719 <alltraps>
...
80105c46:	6a 09                	push   $0x9
  jmp alltraps
80105c48:	e9 cc fa ff ff       	jmp    80105719 <alltraps>
...
80105c4d:	6a 0a                	push   $0xa
  jmp alltraps
80105c4f:	e9 c5 fa ff ff       	jmp    80105719 <alltraps>
...
80105c54:	6a 0b                	push   $0xb
  jmp alltraps
80105c56:	e9 be fa ff ff       	jmp    80105719 <alltraps>
...
80105c69:	6a 0e                	push   $0xe
  jmp alltraps
80105c6b:	e9 a9 fa ff ff       	jmp    80105719 <alltraps>
...
80105c72:	6a 0f                	push   $0xf
  jmp alltraps
80105c74:	e9 a0 fa ff ff       	jmp    80105719 <alltraps>
...
80105c7b:	6a 10                	push   $0x10
  jmp alltraps
80105c7d:	e9 97 fa ff ff       	jmp    80105719 <alltraps>
...
80105c82:	6a 11                	push   $0x11
  jmp alltraps
80105c84:	e9 90 fa ff ff       	jmp    80105719 <alltraps>
...
80105c8b:	6a 12                	push   $0x12
  jmp alltraps
80105c8d:	e9 87 fa ff ff       	jmp    80105719 <alltraps>
...
80105c94:	6a 13                	push   $0x13
  jmp alltraps
80105c96:	e9 7e fa ff ff       	jmp    80105719 <alltraps>
...
80105c9d:	6a 14                	push   $0x14
  jmp alltraps
80105c9f:	e9 75 fa ff ff       	jmp    80105719 <alltraps>
...
80105ca6:	6a 15                	push   $0x15
  jmp alltraps
80105ca8:	e9 6c fa ff ff       	jmp    80105719 <alltraps>
...
80105caf:	6a 16                	push   $0x16
  jmp alltraps
80105cb1:	e9 63 fa ff ff       	jmp    80105719 <alltraps>
...
80105cb8:	6a 17                	push   $0x17
  jmp alltraps
80105cba:	e9 5a fa ff ff       	jmp    80105719 <alltraps>
...
80105cc1:	6a 18                	push   $0x18
  jmp alltraps
80105cc3:	e9 51 fa ff ff       	jmp    80105719 <alltraps>
...
80105cca:	6a 19                	push   $0x19
  jmp alltraps
80105ccc:	e9 48 fa ff ff       	jmp    80105719 <alltraps>
...
80105cd3:	6a 1a                	push   $0x1a
  jmp alltraps
80105cd5:	e9 3f fa ff ff       	jmp    80105719 <alltraps>
...
80105cdc:	6a 1b                	push   $0x1b
  jmp alltraps
80105cde:	e9 36 fa ff ff       	jmp    80105719 <alltraps>
...
80105ce5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ce7:	e9 2d fa ff ff       	jmp    80105719 <alltraps>
...
80105cee:	6a 1d                	push   $0x1d
  jmp alltraps
80105cf0:	e9 24 fa ff ff       	jmp    80105719 <alltraps>
...
80105cf7:	6a 1e                	push   $0x1e
  jmp alltraps
80105cf9:	e9 1b fa ff ff       	jmp    80105719 <alltraps>
...
80105d00:	6a 1f                	push   $0x1f
  jmp alltraps
80105d02:	e9 12 fa ff ff       	jmp    80105719 <alltraps>
...
80105d09:	6a 20                	push   $0x20
  jmp alltraps
80105d0b:	e9 09 fa ff ff       	jmp    80105719 <alltraps>
...
80105d12:	6a 21                	push   $0x21
  jmp alltraps
80105d14:	e9 00 fa ff ff       	jmp    80105719 <alltraps>
...
80105d1b:	6a 22                	push   $0x22
  jmp alltraps
80105d1d:	e9 f7 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d24:	6a 23                	push   $0x23
  jmp alltraps
80105d26:	e9 ee f9 ff ff       	jmp    80105719 <alltraps>
...
80105d2d:	6a 24                	push   $0x24
  jmp alltraps
80105d2f:	e9 e5 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d36:	6a 25                	push   $0x25
  jmp alltraps
80105d38:	e9 dc f9 ff ff       	jmp    80105719 <alltraps>
...
80105d3f:	6a 26                	push   $0x26
  jmp alltraps
80105d41:	e9 d3 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d48:	6a 27                	push   $0x27
  jmp alltraps
80105d4a:	e9 ca f9 ff ff       	jmp    80105719 <alltraps>
...
80105d51:	6a 28                	push   $0x28
  jmp alltraps
80105d53:	e9 c1 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d5a:	6a 29                	push   $0x29
  jmp alltraps
80105d5c:	e9 b8 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d63:	6a 2a                	push   $0x2a
  jmp alltraps
80105d65:	e9 af f9 ff ff       	jmp    80105719 <alltraps>
...
80105d6c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d6e:	e9 a6 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d75:	6a 2c                	push   $0x2c
  jmp alltraps
80105d77:	e9 9d f9 ff ff       	jmp    80105719 <alltraps>
...
80105d7e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d80:	e9 94 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d87:	6a 2e                	push   $0x2e
  jmp alltraps
80105d89:	e9 8b f9 ff ff       	jmp    80105719 <alltraps>
...
80105d90:	6a 2f                	push   $0x2f
  jmp alltraps
80105d92:	e9 82 f9 ff ff       	jmp    80105719 <alltraps>
...
80105d99:	6a 30                	push   $0x30
  jmp alltraps
80105d9b:	e9 79 f9 ff ff       	jmp    80105719 <alltraps>
...
80105da2:	6a 31                	push   $0x31
  jmp alltraps
80105da4:	e9 70 f9 ff ff       	jmp    80105719 <alltraps>
...
80105dab:	6a 32                	push   $0x32
  jmp alltraps
80105dad:	e9 67 f9 ff ff       	jmp    80105719 <alltraps>
...
80105db4:	6a 33                	push   $0x33
  jmp alltraps
80105db6:	e9 5e f9 ff ff       	jmp    80105719 <alltraps>
...
80105dbd:	6a 34                	push   $0x34
  jmp alltraps
80105dbf:	e9 55 f9 ff ff       	jmp    80105719 <alltraps>
...
80105dc6:	6a 35                	push   $0x35
  jmp alltraps
80105dc8:	e9 4c f9 ff ff       	jmp    80105719 <alltraps>
...
80105dcf:	6a 36                	push   $0x36
  jmp alltraps
80105dd1:	e9 43 f9 ff ff       	jmp    80105719 <alltraps>
...
80105dd8:	6a 37                	push   $0x37
  jmp alltraps
80105dda:	e9 3a f9 ff ff       	jmp    80105719 <alltraps>
...
80105de1:	6a 38                	push   $0x38
  jmp alltraps
80105de3:	e9 31 f9 ff ff       	jmp    80105719 <alltraps>
...
80105dea:	6a 39                	push   $0x39
  jmp alltraps
80105dec:	e9 28 f9 ff ff       	jmp    80105719 <alltraps>
...
80105df3:	6a 3a                	push   $0x3a
  jmp alltraps
80105df5:	e9 1f f9 ff ff       	jmp    80105719 <alltraps>
...
80105dfc:	6a 3b                	push   $0x3b
  jmp alltraps
80105dfe:	e9 16 f9 ff ff       	jmp    80105719 <alltraps>
...
80105e05:	6a 3c                	push   $0x3c
  jmp alltraps
80105e07:	e9 0d f9 ff ff       	jmp    80105719 <alltraps>
...
80105e0e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e10:	e9 04 f9 ff ff       	jmp    80105719 <alltraps>
...
80105e17:	6a 3e                	push   $0x3e
  jmp alltraps
80105e19:	e9 fb f8 ff ff       	jmp    80105719 <alltraps>
...
80105e20:	6a 3f                	push   $0x3f
  jmp alltraps
80105e22:	e9 f2 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e29:	6a 40                	push   $0x40
  jmp alltraps
80105e2b:	e9 e9 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e32:	6a 41                	push   $0x41
  jmp alltraps
80105e34:	e9 e0 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e3b:	6a 42                	push   $0x42
  jmp alltraps
80105e3d:	e9 d7 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e44:	6a 43                	push   $0x43
  jmp alltraps
80105e46:	e9 ce f8 ff ff       	jmp    80105719 <alltraps>
...
80105e4d:	6a 44                	push   $0x44
  jmp alltraps
80105e4f:	e9 c5 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e56:	6a 45                	push   $0x45
  jmp alltraps
80105e58:	e9 bc f8 ff ff       	jmp    80105719 <alltraps>
...
80105e5f:	6a 46                	push   $0x46
  jmp alltraps
80105e61:	e9 b3 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e68:	6a 47                	push   $0x47
  jmp alltraps
80105e6a:	e9 aa f8 ff ff       	jmp    80105719 <alltraps>
...
80105e71:	6a 48                	push   $0x48
  jmp alltraps
80105e73:	e9 a1 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e7a:	6a 49                	push   $0x49
  jmp alltraps
80105e7c:	e9 98 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e83:	6a 4a                	push   $0x4a
  jmp alltraps
80105e85:	e9 8f f8 ff ff       	jmp    80105719 <alltraps>
...
80105e8c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e8e:	e9 86 f8 ff ff       	jmp    80105719 <alltraps>
...
80105e95:	6a 4c                	push   $0x4c
  jmp alltraps
80105e97:	e9 7d f8 ff ff       	jmp    80105719 <alltraps>
...
80105e9e:	6a 4d                	push   $0x4d
  jmp alltraps
80105ea0:	e9 74 f8 ff ff       	jmp    80105719 <alltraps>
...
80105ea7:	6a 4e                	push   $0x4e
  jmp alltraps
80105ea9:	e9 6b f8 ff ff       	jmp    80105719 <alltraps>
...
80105eb0:	6a 4f                	push   $0x4f
  jmp alltraps
80105eb2:	e9 62 f8 ff ff       	jmp    80105719 <alltraps>
...
80105eb9:	6a 50                	push   $0x50
  jmp alltraps
80105ebb:	e9 59 f8 ff ff       	jmp    80105719 <alltraps>
...
80105ec2:	6a 51                	push   $0x51
  jmp alltraps
80105ec4:	e9 50 f8 ff ff       	jmp    80105719 <alltraps>
...
80105ecb:	6a 52                	push   $0x52
  jmp alltraps
80105ecd:	e9 47 f8 ff ff       	jmp    80105719 <alltraps>
...
80105ed4:	6a 53                	push   $0x53
  jmp alltraps
80105ed6:	e9 3e f8 ff ff       	jmp    80105719 <alltraps>
...
80105edd:	6a 54                	push   $0x54
  jmp alltraps
80105edf:	e9 35 f8 ff ff       	jmp    80105719 <alltraps>
...
80105ee6:	6a 55                	push   $0x55
  jmp alltraps
80105ee8:	e9 2c f8 ff ff       	jmp    80105719 <alltraps>
...
80105eef:	6a 56                	push   $0x56
  jmp alltraps
80105ef1:	e9 23 f8 ff ff       	jmp    80105719 <alltraps>
...
80105ef8:	6a 57                	push   $0x57
  jmp alltraps
80105efa:	e9 1a f8 ff ff       	jmp    80105719 <alltraps>
...
80105f01:	6a 58                	push   $0x58
  jmp alltraps
80105f03:	e9 11 f8 ff ff       	jmp    80105719 <alltraps>
...
80105f0a:	6a 59                	push   $0x59
  jmp alltraps
80105f0c:	e9 08 f8 ff ff       	jmp    80105719 <alltraps>
...
80105f13:	6a 5a                	push   $0x5a
  jmp alltraps
80105f15:	e9 ff f7 ff ff       	jmp    80105719 <alltraps>
...
80105f1c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f1e:	e9 f6 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f25:	6a 5c                	push   $0x5c
  jmp alltraps
80105f27:	e9 ed f7 ff ff       	jmp    80105719 <alltraps>
...
80105f2e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f30:	e9 e4 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f37:	6a 5e                	push   $0x5e
  jmp alltraps
80105f39:	e9 db f7 ff ff       	jmp    80105719 <alltraps>
...
80105f40:	6a 5f                	push   $0x5f
  jmp alltraps
80105f42:	e9 d2 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f49:	6a 60                	push   $0x60
  jmp alltraps
80105f4b:	e9 c9 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f52:	6a 61                	push   $0x61
  jmp alltraps
80105f54:	e9 c0 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f5b:	6a 62                	push   $0x62
  jmp alltraps
80105f5d:	e9 b7 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f64:	6a 63                	push   $0x63
  jmp alltraps
80105f66:	e9 ae f7 ff ff       	jmp    80105719 <alltraps>
...
80105f6d:	6a 64                	push   $0x64
  jmp alltraps
80105f6f:	e9 a5 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f76:	6a 65                	push   $0x65
  jmp alltraps
80105f78:	e9 9c f7 ff ff       	jmp    80105719 <alltraps>
...
80105f7f:	6a 66                	push   $0x66
  jmp alltraps
80105f81:	e9 93 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f88:	6a 67                	push   $0x67
  jmp alltraps
80105f8a:	e9 8a f7 ff ff       	jmp    80105719 <alltraps>
...
80105f91:	6a 68                	push   $0x68
  jmp alltraps
80105f93:	e9 81 f7 ff ff       	jmp    80105719 <alltraps>
...
80105f9a:	6a 69                	push   $0x69
  jmp alltraps
80105f9c:	e9 78 f7 ff ff       	jmp    80105719 <alltraps>
...
80105fa3:	6a 6a                	push   $0x6a
  jmp alltraps
80105fa5:	e9 6f f7 ff ff       	jmp    80105719 <alltraps>
...
80105fac:	6a 6b                	push   $0x6b
  jmp alltraps
80105fae:	e9 66 f7 ff ff       	jmp    80105719 <alltraps>
...
80105fb5:	6a 6c                	push   $0x6c
  jmp alltraps
80105fb7:	e9 5d f7 ff ff       	jmp    80105719 <alltraps>
...
80105fbe:	6a 6d                	push   $0x6d
  jmp alltraps
80105fc0:	e9 54 f7 ff ff       	jmp    80105719 <alltraps>
...
80105fc7:	6a 6e                	push   $0x6e
  jmp alltraps
80105fc9:	e9 4b f7 ff ff       	jmp    80105719 <alltraps>
...
80105fd0:	6a 6f                	push   $0x6f
  jmp alltraps
80105fd2:	e9 42 f7 ff ff       	jmp    80105719 <alltraps>
...
80105fd9:	6a 70                	push   $0x70
  jmp alltraps
80105fdb:	e9 39 f7 ff ff       	jmp    80105719 <alltraps>
...
80105fe2:	6a 71                	push   $0x71
  jmp alltraps
80105fe4:	e9 30 f7 ff ff       	jmp    80105719 <alltraps>
...
80105feb:	6a 72                	push   $0x72
  jmp alltraps
80105fed:	e9 27 f7 ff ff       	jmp    80105719 <alltraps>
...
80105ff4:	6a 73                	push   $0x73
  jmp alltraps
80105ff6:	e9 1e f7 ff ff       	jmp    80105719 <alltraps>
...
80105ffd:	6a 74                	push   $0x74
  jmp alltraps
80105fff:	e9 15 f7 ff ff       	jmp    80105719 <alltraps>
...
80106006:	6a 75                	push   $0x75
  jmp alltraps
80106008:	e9 0c f7 ff ff       	jmp    80105719 <alltraps>
...
8010600f:	6a 76                	push   $0x76
  jmp alltraps
80106011:	e9 03 f7 ff ff       	jmp    80105719 <alltraps>
...
80106018:	6a 77                	push   $0x77
  jmp alltraps
8010601a:	e9 fa f6 ff ff       	jmp    80105719 <alltraps>
...
80106021:	6a 78                	push   $0x78
  jmp alltraps
80106023:	e9 f1 f6 ff ff       	jmp    80105719 <alltraps>
...
8010602a:	6a 79                	push   $0x79
  jmp alltraps
8010602c:	e9 e8 f6 ff ff       	jmp    80105719 <alltraps>
...
80106033:	6a 7a                	push   $0x7a
  jmp alltraps
80106035:	e9 df f6 ff ff       	jmp    80105719 <alltraps>
...
8010603c:	6a 7b                	push   $0x7b
  jmp alltraps
8010603e:	e9 d6 f6 ff ff       	jmp    80105719 <alltraps>
...
80106045:	6a 7c                	push   $0x7c
  jmp alltraps
80106047:	e9 cd f6 ff ff       	jmp    80105719 <alltraps>
...
8010604e:	6a 7d                	push   $0x7d
  jmp alltraps
80106050:	e9 c4 f6 ff ff       	jmp    80105719 <alltraps>
...
80106057:	6a 7e                	push   $0x7e
  jmp alltraps
80106059:	e9 bb f6 ff ff       	jmp    80105719 <alltraps>
...
80106060:	6a 7f                	push   $0x7f
  jmp alltraps
80106062:	e9 b2 f6 ff ff       	jmp    80105719 <alltraps>
...
80106069:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010606e:	e9 a6 f6 ff ff       	jmp    80105719 <alltraps>
...
80106075:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010607a:	e9 9a f6 ff ff       	jmp    80105719 <alltraps>
...
80106081:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106086:	e9 8e f6 ff ff       	jmp    80105719 <alltraps>
...
8010608d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106092:	e9 82 f6 ff ff       	jmp    80105719 <alltraps>
...
80106099:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010609e:	e9 76 f6 ff ff       	jmp    80105719 <alltraps>
...
801060a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801060aa:	e9 6a f6 ff ff       	jmp    80105719 <alltraps>
...
801060b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801060b6:	e9 5e f6 ff ff       	jmp    80105719 <alltraps>
...
801060bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060c2:	e9 52 f6 ff ff       	jmp    80105719 <alltraps>
...
801060c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060ce:	e9 46 f6 ff ff       	jmp    80105719 <alltraps>
...
801060d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060da:	e9 3a f6 ff ff       	jmp    80105719 <alltraps>
...
801060e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060e6:	e9 2e f6 ff ff       	jmp    80105719 <alltraps>
...
801060ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060f2:	e9 22 f6 ff ff       	jmp    80105719 <alltraps>
...
801060f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060fe:	e9 16 f6 ff ff       	jmp    80105719 <alltraps>
...
80106105:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010610a:	e9 0a f6 ff ff       	jmp    80105719 <alltraps>
...
80106111:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106116:	e9 fe f5 ff ff       	jmp    80105719 <alltraps>
...
8010611d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106122:	e9 f2 f5 ff ff       	jmp    80105719 <alltraps>
...
80106129:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010612e:	e9 e6 f5 ff ff       	jmp    80105719 <alltraps>
...
80106135:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010613a:	e9 da f5 ff ff       	jmp    80105719 <alltraps>
...
80106141:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106146:	e9 ce f5 ff ff       	jmp    80105719 <alltraps>
...
8010614d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106152:	e9 c2 f5 ff ff       	jmp    80105719 <alltraps>
...
80106159:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010615e:	e9 b6 f5 ff ff       	jmp    80105719 <alltraps>
...
80106165:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010616a:	e9 aa f5 ff ff       	jmp    80105719 <alltraps>
...
80106171:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106176:	e9 9e f5 ff ff       	jmp    80105719 <alltraps>
...
8010617d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106182:	e9 92 f5 ff ff       	jmp    80105719 <alltraps>
...
80106189:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010618e:	e9 86 f5 ff ff       	jmp    80105719 <alltraps>
...
80106195:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010619a:	e9 7a f5 ff ff       	jmp    80105719 <alltraps>
...
801061a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801061a6:	e9 6e f5 ff ff       	jmp    80105719 <alltraps>
...
801061ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801061b2:	e9 62 f5 ff ff       	jmp    80105719 <alltraps>
...
801061b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801061be:	e9 56 f5 ff ff       	jmp    80105719 <alltraps>
...
801061c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061ca:	e9 4a f5 ff ff       	jmp    80105719 <alltraps>
...
801061d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061d6:	e9 3e f5 ff ff       	jmp    80105719 <alltraps>
...
801061dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061e2:	e9 32 f5 ff ff       	jmp    80105719 <alltraps>
...
801061e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061ee:	e9 26 f5 ff ff       	jmp    80105719 <alltraps>
...
801061f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061fa:	e9 1a f5 ff ff       	jmp    80105719 <alltraps>
...
80106201:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106206:	e9 0e f5 ff ff       	jmp    80105719 <alltraps>
...
8010620d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106212:	e9 02 f5 ff ff       	jmp    80105719 <alltraps>
...
80106219:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010621e:	e9 f6 f4 ff ff       	jmp    80105719 <alltraps>
...
80106225:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010622a:	e9 ea f4 ff ff       	jmp    80105719 <alltraps>
...
80106231:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106236:	e9 de f4 ff ff       	jmp    80105719 <alltraps>
...
8010623d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106242:	e9 d2 f4 ff ff       	jmp    80105719 <alltraps>
...
80106249:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010624e:	e9 c6 f4 ff ff       	jmp    80105719 <alltraps>
...
80106255:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010625a:	e9 ba f4 ff ff       	jmp    80105719 <alltraps>
...
80106261:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106266:	e9 ae f4 ff ff       	jmp    80105719 <alltraps>
...
8010626d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106272:	e9 a2 f4 ff ff       	jmp    80105719 <alltraps>
...
80106279:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010627e:	e9 96 f4 ff ff       	jmp    80105719 <alltraps>
...
80106285:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010628a:	e9 8a f4 ff ff       	jmp    80105719 <alltraps>
...
80106291:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106296:	e9 7e f4 ff ff       	jmp    80105719 <alltraps>
...
8010629d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801062a2:	e9 72 f4 ff ff       	jmp    80105719 <alltraps>
...
801062a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801062ae:	e9 66 f4 ff ff       	jmp    80105719 <alltraps>
...
801062b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801062ba:	e9 5a f4 ff ff       	jmp    80105719 <alltraps>
...
801062c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062c6:	e9 4e f4 ff ff       	jmp    80105719 <alltraps>
...
801062cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062d2:	e9 42 f4 ff ff       	jmp    80105719 <alltraps>
...
801062d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062de:	e9 36 f4 ff ff       	jmp    80105719 <alltraps>
...
801062e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062ea:	e9 2a f4 ff ff       	jmp    80105719 <alltraps>
...
801062f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062f6:	e9 1e f4 ff ff       	jmp    80105719 <alltraps>
...
801062fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106302:	e9 12 f4 ff ff       	jmp    80105719 <alltraps>
...
80106309:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010630e:	e9 06 f4 ff ff       	jmp    80105719 <alltraps>
...
80106315:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010631a:	e9 fa f3 ff ff       	jmp    80105719 <alltraps>
...
80106321:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106326:	e9 ee f3 ff ff       	jmp    80105719 <alltraps>
...
8010632d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106332:	e9 e2 f3 ff ff       	jmp    80105719 <alltraps>
...
80106339:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010633e:	e9 d6 f3 ff ff       	jmp    80105719 <alltraps>
...
80106345:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010634a:	e9 ca f3 ff ff       	jmp    80105719 <alltraps>
...
80106351:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106356:	e9 be f3 ff ff       	jmp    80105719 <alltraps>
...
8010635d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106362:	e9 b2 f3 ff ff       	jmp    80105719 <alltraps>
...
80106369:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010636e:	e9 a6 f3 ff ff       	jmp    80105719 <alltraps>
...
80106375:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010637a:	e9 9a f3 ff ff       	jmp    80105719 <alltraps>
...
80106381:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106386:	e9 8e f3 ff ff       	jmp    80105719 <alltraps>
...
8010638d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106392:	e9 82 f3 ff ff       	jmp    80105719 <alltraps>
...
80106399:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010639e:	e9 76 f3 ff ff       	jmp    80105719 <alltraps>
...
801063a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801063aa:	e9 6a f3 ff ff       	jmp    80105719 <alltraps>
...
801063b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801063b6:	e9 5e f3 ff ff       	jmp    80105719 <alltraps>
...
801063bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063c2:	e9 52 f3 ff ff       	jmp    80105719 <alltraps>
...
801063c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063ce:	e9 46 f3 ff ff       	jmp    80105719 <alltraps>
...
801063d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063da:	e9 3a f3 ff ff       	jmp    80105719 <alltraps>
...
801063e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063e6:	e9 2e f3 ff ff       	jmp    80105719 <alltraps>
...
801063ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063f2:	e9 22 f3 ff ff       	jmp    80105719 <alltraps>
...
801063f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063fe:	e9 16 f3 ff ff       	jmp    80105719 <alltraps>
...
80106405:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010640a:	e9 0a f3 ff ff       	jmp    80105719 <alltraps>
...
80106411:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106416:	e9 fe f2 ff ff       	jmp    80105719 <alltraps>
...
8010641d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106422:	e9 f2 f2 ff ff       	jmp    80105719 <alltraps>
...
80106429:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010642e:	e9 e6 f2 ff ff       	jmp    80105719 <alltraps>
...
80106435:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010643a:	e9 da f2 ff ff       	jmp    80105719 <alltraps>
...
80106441:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106446:	e9 ce f2 ff ff       	jmp    80105719 <alltraps>
...
8010644d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106452:	e9 c2 f2 ff ff       	jmp    80105719 <alltraps>
...
80106459:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010645e:	e9 b6 f2 ff ff       	jmp    80105719 <alltraps>
...
80106465:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010646a:	e9 aa f2 ff ff       	jmp    80105719 <alltraps>
...
80106471:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106476:	e9 9e f2 ff ff       	jmp    80105719 <alltraps>
...
8010647d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106482:	e9 92 f2 ff ff       	jmp    80105719 <alltraps>
...
80106489:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010648e:	e9 86 f2 ff ff       	jmp    80105719 <alltraps>
...
80106495:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010649a:	e9 7a f2 ff ff       	jmp    80105719 <alltraps>
...
801064a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801064a6:	e9 6e f2 ff ff       	jmp    80105719 <alltraps>
...
801064ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801064b2:	e9 62 f2 ff ff       	jmp    80105719 <alltraps>
...
801064b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801064be:	e9 56 f2 ff ff       	jmp    80105719 <alltraps>
...
801064c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064ca:	e9 4a f2 ff ff       	jmp    80105719 <alltraps>
...
801064d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064d6:	e9 3e f2 ff ff       	jmp    80105719 <alltraps>
...
801064dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064e2:	e9 32 f2 ff ff       	jmp    80105719 <alltraps>
...
801064e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064ee:	e9 26 f2 ff ff       	jmp    80105719 <alltraps>
...
801064f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064fa:	e9 1a f2 ff ff       	jmp    80105719 <alltraps>
...
80106501:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106506:	e9 0e f2 ff ff       	jmp    80105719 <alltraps>
...
8010650d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106512:	e9 02 f2 ff ff       	jmp    80105719 <alltraps>
...
80106519:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010651e:	e9 f6 f1 ff ff       	jmp    80105719 <alltraps>
...
80106525:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010652a:	e9 ea f1 ff ff       	jmp    80105719 <alltraps>
...
80106531:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106536:	e9 de f1 ff ff       	jmp    80105719 <alltraps>
...
8010653d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106542:	e9 d2 f1 ff ff       	jmp    80105719 <alltraps>
...
80106549:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010654e:	e9 c6 f1 ff ff       	jmp    80105719 <alltraps>
...
80106555:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010655a:	e9 ba f1 ff ff       	jmp    80105719 <alltraps>
...
80106561:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106566:	e9 ae f1 ff ff       	jmp    80105719 <alltraps>
...
8010656d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106572:	e9 a2 f1 ff ff       	jmp    80105719 <alltraps>
...
80106579:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010657e:	e9 96 f1 ff ff       	jmp    80105719 <alltraps>
...
80106585:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010658a:	e9 8a f1 ff ff       	jmp    80105719 <alltraps>
...
80106591:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106596:	e9 7e f1 ff ff       	jmp    80105719 <alltraps>
...
8010659d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801065a2:	e9 72 f1 ff ff       	jmp    80105719 <alltraps>
...
801065a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801065ae:	e9 66 f1 ff ff       	jmp    80105719 <alltraps>
...
801065b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801065ba:	e9 5a f1 ff ff       	jmp    80105719 <alltraps>
...
801065c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065c6:	e9 4e f1 ff ff       	jmp    80105719 <alltraps>
...
801065cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065d2:	e9 42 f1 ff ff       	jmp    80105719 <alltraps>
...
801065d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065de:	e9 36 f1 ff ff       	jmp    80105719 <alltraps>
...
801065e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065ea:	e9 2a f1 ff ff       	jmp    80105719 <alltraps>
...
801065f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065f6:	e9 1e f1 ff ff       	jmp    80105719 <alltraps>
...
801065fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106602:	e9 12 f1 ff ff       	jmp    80105719 <alltraps>
...
80106609:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010660e:	e9 06 f1 ff ff       	jmp    80105719 <alltraps>
...
80106615:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010661a:	e9 fa f0 ff ff       	jmp    80105719 <alltraps>
...
80106621:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106626:	e9 ee f0 ff ff       	jmp    80105719 <alltraps>
...
8010662d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106632:	e9 e2 f0 ff ff       	jmp    80105719 <alltraps>
...
80106639:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010663e:	e9 d6 f0 ff ff       	jmp    80105719 <alltraps>
...
80106645:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010664a:	e9 ca f0 ff ff       	jmp    80105719 <alltraps>
...
80106651:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106656:	e9 be f0 ff ff       	jmp    80105719 <alltraps>
...
8010665d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106662:	e9 b2 f0 ff ff       	jmp    80105719 <alltraps>
...
8010676d:	68 cc 78 10 80       	push   $0x801078cc
...
801068f4:	0f 84 c2 00 00 00    	je     801069bc <switchuvm+0xec>
  pushcli();
801068fa:	e8 51 da ff ff       	call   80104350 <pushcli>
...
80106a0f:	e8 1c db ff ff       	call   80104530 <memset>
...
80106a40:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a41:	e9 9a db ff ff       	jmp    801045e0 <memmove>
    panic("inituvm: more than a page");
80106a46:	83 ec 0c             	sub    $0xc,%esp
80106a49:	68 11 79 10 80       	push   $0x80107911
...
80106b6b:	e8 c0 d9 ff ff       	call   80104530 <memset>
...
80106bad:	68 49 79 10 80       	push   $0x80107949
...
80106be3:	68 61 79 10 80       	push   $0x80107961
...
80106ea9:	68 b2 79 10 80       	push   $0x801079b2
80106eae:	e8 dd 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106eb3:	83 ec 0c             	sub    $0xc,%esp
80106eb6:	68 98 79 10 80       	push   $0x80107998
