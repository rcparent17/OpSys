...
int main(void){
  ...
  19:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
	...
	for(i = 0; i < numForks; i++){
		if(fork() == 0){
  20:	e8 a5 02 00 00       	call   2ca <fork>
  25:	85 c0                	test   %eax,%eax
  27:	75 3f                	jne    68 <main+0x68>
			for(x = 0.1; x < 8000000.0; x += 0.1)
  29:	d9 05 88 07 00 00    	flds   0x788
  2f:	dd 05 90 07 00 00    	fldl   0x790
  35:	eb 0b                	jmp    42 <main+0x42>
  37:	89 f6                	mov    %esi,%esi
  39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  40:	d9 c9                	fxch   %st(1)
  42:	dc c1                	fadd   %st,%st(1)
  44:	d9 c9                	fxch   %st(1)
  46:	d9 5d f4             	fstps  -0xc(%ebp)
  49:	d9 45 f4             	flds   -0xc(%ebp)
  4c:	d9 05 8c 07 00 00    	flds   0x78c
  52:	df e9                	fucomip %st(1),%st
  54:	77 ea                	ja     40 <main+0x40>
  56:	dd d8                	fstp   %st(0)
  58:	dd d8                	fstp   %st(0)
	for(i = 0; i < numForks; i++){
  5a:	83 eb 01             	sub    $0x1,%ebx
  5d:	75 c1                	jne    20 <main+0x20>
		}
		else{
			wait();
		}
  ...
  64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			wait();
  68:	e8 6d 02 00 00       	call   2da <wait>
	for(i = 0; i < numForks; i++){
  6d:	83 eb 01             	sub    $0x1,%ebx
  70:	75 ae                	jne    20 <main+0x20>
  72:	eb eb                	jmp    5f <main+0x5f>
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
