...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb b8 07 00 00       	mov    $0x7b8,%ebx
        while(*s != 0){
 ...
 5f1:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 6c 0a 00 00       	mov    %eax,0xa6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 6c 0a 00 00    	cmp    %eax,0xa6c
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 6c 0a 00 00    	mov    %edx,0xa6c
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 6c 0a 00 00 70 	movl   $0xa70,0xa6c
 747:	0a 00 00 
 74a:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 70 0a 00 00       	mov    $0xa70,%eax
 759:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 760:	00 00 00 
